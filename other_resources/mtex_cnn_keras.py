...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  6 19:18:03 2022
...
def mtex_cnn(input_shape, n_class):
    ...
    a = Conv2D(filters=64, kernel_size=(8, 1), strides=(2, 1), padding='same', input_shape=(n, k, 1), name='2D_1')(input_layer)
    a = Activation('relu', name='2D_1_Activation')(a)
    a = Dropout(0.4)(a)
    a = Conv2D(filters=128, kernel_size=(6, 1), strides=(2, 1), padding='same', name='2D_2')(a)
    ...
    b = Conv1D(filters=128, kernel_size=4, strides=2, input_shape=(int(n/4), k), name='1D')(x)
